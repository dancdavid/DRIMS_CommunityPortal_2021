...
$dbh = $_db->initDB();
$qry = "select * from cp_events_calendar where id = :id";
$sth = $dbh->prepare($qry);
...
<div class="col-sm-12 col-xs-12">
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" id="postMessage" role="form" method="post" action="../_lib/action.php?action=<?php echo $_core->encode('editEvent'); ?>">
...
<!--                            </div>-->
                    ...
                    <div class="form-group">
                        ...
                        echo $_files->DeleteFilesTable($event_id,'cp_events_calendar_file_upload');
                        ?>
                    </div>
...
<script>
    $(function () {
        ...
        // set previous selected timezone
        ...
        $('.delete').on('click', function(e) {
            ...
            $.post("../_lib/ajax.php?action=DeleteEventFile", { id: fileId });
