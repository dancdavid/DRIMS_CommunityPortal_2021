...
<!-- modal Inactive Org -->
<div class="modal fade" id="modalInactiveOrg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title text-danger" id="myModalLabel">Inactive Organization</h4>
            </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12  col-xs-12">
                            <p>
                                This organization cannot be invited as the organization is no longer active in DRIMS tools. </p>
                                <p>  If you wish to add them to your CP or If you feel this is an error, please contact DRIMS technical support for assistance.
                            </p>
                        </div>
                    </div>
                </div>
