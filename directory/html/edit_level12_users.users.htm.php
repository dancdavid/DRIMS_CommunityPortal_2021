...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="#">Level 1 Users</a></li>
            <?php
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="collapse" id="collapseAddUser">
                    <div class="well">
                        <table width="100%" id="level1AddForm" class="table table-bordered">
                            <form class="form-horizontal" enctype="multipart/form-data" id="addLevel1User" role="form" method="post"
                                  action="../_lib/agencyaction.php?action=<?= $_core->encode('AddLevel1User'); ?>">
                ...
                <table id="level1users" class="table table-bordered table-striped" style="font-size:12px" width="100%">
                    <thead>
                    <tr>
                        <th>NAME</th>
                        <th>EMAIL</th>
...
<script>
    $(function () {
        ...
        $("#level1users").DataTable({
            "bProcessing": false,
            "sPaginationType": "full_numbers",
            "sDom": '<"top"fl>rt<"clear">',
            "bStateSave": false,
            "sAjaxSource": "../_lib/ajax.php?action=getLevel1Users",
            "oLanguage": {
