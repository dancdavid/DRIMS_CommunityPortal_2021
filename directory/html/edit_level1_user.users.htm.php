        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="well">
                    ...
                    <table width="100%" id="level1EditForm" class="table table-bordered">
                        <form class="form-horizontal" enctype="multipart/form-data" id="editLevel1User" role="form" method="post"
                              action="../_lib/agencyaction.php?action=<?= $_core->encode('EditLevel1User'); ?>">
